...
type Listener<R extends EventRegistry, T extends keyof R, Target = unknown> = (
  event: EventOf<R, T, Target>
) => void;
...
function _addEventListener<
  R extends EventRegistry,
  T extends keyof R,
  Target extends Evented<R>
>(
  type: T,
  listener: Listener<R, T, Target>,
  listenerList: Listeners<R, Target>
) {
...
export class Evented<R extends EventRegistry = EventRegistry> {
  _listeners: Listeners<R, this> = {};
  _oneTimeListeners: Listeners<R, this> = {};
  ...
  on<T extends keyof R | (string & {})>(
    type: T,
    listener: Listener<R, T, this>
  ): this {
    this._listeners = this._listeners || {};
    _addEventListener<R, T, this>(type, listener, this._listeners);
   ...
   * @returns {Object} Returns itself to allow for method chaining.
   */
  off<T extends keyof R | (string & {})>(
    type: T,
    listener: Listener<R, T, this>
  ): this {
    _removeEventListener<R, T, this>(type, listener, this._listeners);
    _removeEventListener<R, T, this>(type, listener, this._oneTimeListeners);
   ...
   */
  once<T extends keyof R | (string & {})>(
    type: T
  ): Promise<EventOf<R, T, this>>;
  once<T extends keyof R | (string & {})>(
    type: T,
    listener: Listener<R, T, this>
  ): this;
  once<T extends keyof R | (string & {})>(
    ...
    _addEventListener<R, T, this>(type, listener, this._oneTimeListeners);
  ...
  fire<T extends keyof R | (string & {})>(
    ...
    const event =
      typeof e === "string"
        ? new Event(e, eventData as R[T] extends void ? [] : [R[T]])
        : (e as Event<R, T>);
